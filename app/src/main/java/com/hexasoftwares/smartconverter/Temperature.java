...
public class Temperature extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    Double value;
    String[] CONV_OPTIONS_FROM = {"Unit from" ,"Celsius","Fahrenheit","kelvin"};
    String[] CONV_OPTIONS_TO = {"Unit to" ,"Celsius","Fahrenheit","kelvin"};
    String[] ITEM_SIGN = {"--","°C","°F","K"};
    EditText e1;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_about) {
            Intent i = new Intent(Temperature.this, Splash.class);
            startActivity(i);}
    ...
    public void ConvAction(View view) {
        ...
        switch (index_from) {
            ...
            case 1: {switch (index_to) {
                case 0: {Toast.makeText(this,"Please choose any option", Toast.LENGTH_LONG).show();break;}
                case 2: {value = (1.8 * value) + 32;break;}
                case 3: {value = value+273.15;break;}
            }break;
            }

            case 2: {switch (index_to) {
                case 0: {Toast.makeText(this,"Please choose any option", Toast.LENGTH_LONG).show();break;}
                case 1: {value = (value-32)/1.8;break;}
                case 3: {value =  (value + 459.67)* 5/9;break;}
            }break;
            }

            case 3: {switch (index_to) {
                case 0: {Toast.makeText(this,"Please choose any option", Toast.LENGTH_LONG).show();break;}
                case 1: {value = value-273.15;break;}
                case 2: {value = (value*1.8) -459.67;break;}
            }break;
            }
        }
