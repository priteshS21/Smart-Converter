...
public class DigitalStorage extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    Double value;
    String[] CONV_OPTIONS_FROM = {"Unit from" ,"Bit","Byte"};
    String[] CONV_OPTIONS_TO = {"Unit to" ,"Bit","Byte"};
    String[] ITEM_SIGN = {"--","b","b"};
    EditText e1;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_about) {
            Intent i = new Intent(DigitalStorage.this, Splash.class);
            startActivity(i);}
    ...
    public void ConvAction(View view) {
        ...
        switch (index_from) {
            ...
            case 1: {switch (index_to) {
                case 0: {Toast.makeText(this,"Please choose any option", Toast.LENGTH_LONG).show();break;}
                case 2: {value = value*0.62137119; /* g to kg*/ break;}
            ...
            case 2: {switch (index_to) {
                case 0: {Toast.makeText(this,"Please choose any option", Toast.LENGTH_LONG).show();break;}
                case 1: {value= value*1.609344;break;}
