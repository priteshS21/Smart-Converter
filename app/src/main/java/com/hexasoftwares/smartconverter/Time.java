...
public class Time extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    Double value;
    String[] CONV_OPTIONS_FROM = {"Unit from" ,"Hour","Min","Sec"};
    String[] CONV_OPTIONS_TO = {"Unit to" ,"Hour","Min","Sec"};
    String[] ITEM_SIGN = {"--","Hr","Min","Sec"};
    EditText e1;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_about) {
            Intent i = new Intent(Time.this, Splash.class);
            startActivity(i);}
    ...
    public void ConvAction(View view) {
        ...
        switch (index_from) {
            ...
            case 1: {switch (index_to) {
                case 0: {Toast.makeText(this,"Please choose any option", Toast.LENGTH_LONG).show();break;}
                case 2: {value = value*60;break;}
                case 3: {value = value*3600;break;}
            }break;
            }

            case 2: {switch (index_to) {
                case 0: {Toast.makeText(this,"Please choose any option", Toast.LENGTH_LONG).show();break;}
                case 1: {value = value*60;break;}
                case 3: {value = value/60;break;}
            }break;
            }

            case 3: {switch (index_to) {
                case 0: {Toast.makeText(this,"Please choose any option", Toast.LENGTH_LONG).show();break;}
                case 1: {value = value/3600;}
                case 2: {value = value/60;break;}
            }break;
            }
        }
