...
public class Frequency extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    Double value;
    String[] CONV_OPTIONS_FROM = {"From unit", "Hertz", "kilohertz", "Megahertz", "Gigahertz"};
    String[] CONV_OPTIONS_TO = {"To unit", "Hertz", "kilohertz", "Megahertz", "Gigahertz"};
    String[] ITEM_SIGN = {"--","Hz","kHz","MHz","GHz"};
    EditText e1;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_about) {
            Intent i = new Intent(Frequency.this, Splash.class);
            startActivity(i);}
