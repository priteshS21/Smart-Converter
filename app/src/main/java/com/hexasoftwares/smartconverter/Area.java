...
public class Area extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    Double value;
    String[] CONV_OPTIONS_FROM = {"From unit", "Acre", "Hectare", "Square foot", "Square inch"};
    String[] CONV_OPTIONS_TO = {"To unit", "Acre", "Hectare", "Square foot", "Square inch"};
    String[] ITEM_SIGN = {"--","ac","ha","ft2","in2"};
    EditText e1;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_about) {
            Intent i = new Intent(Area.this, Splash.class);
            startActivity(i);}
    ...
    public void ConvAction(View view) {
        ...
        switch (index_from) {
            case 0: {
                Toast.makeText(this, "Please choose any option", Toast.LENGTH_LONG).show();
                break;
            }
            case 1: {
                switch (index_to) {
                    ...
                    case 2: {
                        value = value * 0.40468564; /* Area - Hect*/
                        break;
                    }
                    case 3: {
                        value = value * 1000000;  /* Area - Sq. Ft*/
                        break;
                    }
                    case 4: {
                        value = value * 1000000000;  /* Area - Sq. Inch*/
                        break;
                    }
                }
                break;
            ...
            case 2: {
                switch (index_to) {
                    ...
                    case 1: {
                        value = value * 1000;  /*Hect - Area*/
                        break;
                    }
                    case 3: {
                        value = value / 1000;  /*Hect - Sq. Ft*/
                        break;
                    }
                    case 4: {
                        value = value / 1000000;  /*Hect - Sq. Inch*/
                        break;
                    }
                }
                break;
            ...
            case 3: {
                switch (index_to) {
                    ...
                    case 1: {
                        value = value * 1000000;  /*Sq. Ft - Area*/
                        break;
                    }
                    case 2: {
                        value = value * 1000;  /*Sq. Ft - Hect*/
                        break;
                    }
                    case 4: {
                        value = value / 1000;  /*Sq. Ft - Sq. Inch*/
                        break;
                    }
                }
                break;
            ...
            case 4: {
                switch (index_to) {
                    ...
                    case 1: {
                        value = value * 1000000000;  /*Sq. Inch - Area*/
                        break;
                    }
                    case 2: {
                        value = value * 1000000;  /*Sq. Inch - Hect*/
                        break;
                    }
                    case 3: {
                        value = value * 1000;  /*Sq. Inch - Sq. Ft*/
                        break;
                    }
                }
                break;
